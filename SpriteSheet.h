...
public:
	...
	/// <summary>
	/// Loads a texture and parses sprite sheet data from a file.
	/// </summary>
	/// <param name="texture">A pointer to an ID3D11ShaderResourceView representing the texture to load.</param>
	/// <param name="szFileName">The path to the sprite sheet data file in wide-character string format. Can be null if no file is provided.</param>
