...
constexpr auto ID_ENT_BUSH_LITTLE                   = 11;
constexpr auto ID_ENT_BUSH_SMALL                    = 12;
constexpr auto ID_ENT_BUSH_MID                      = 13;
constexpr auto ID_ENT_BUSH_BIG                      = 14;
...
constexpr auto ID_ENT_SCREW_BLOCK                   = 22;
constexpr auto ID_ENT_GRASS_BLOCK                   = 23;
constexpr auto ID_ENT_BRICK                         = 24;
constexpr auto ID_ENT_WOOD                          = 25;
constexpr auto ID_ENT_WOOD_HOVER_PLATFORM           = 26;
