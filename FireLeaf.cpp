...
Leaf::Leaf(Vector2 position, Vector2 size, SpriteSheet* spriteSheet)
...
void Leaf::Render(DirectX::SpriteBatch* spriteBatch)
{
	Entity::Render(spriteBatch);
}

void Leaf::OnCollision(const CollisionResult& event)
{
...
void Leaf::SetupCollisionComponent()
{
